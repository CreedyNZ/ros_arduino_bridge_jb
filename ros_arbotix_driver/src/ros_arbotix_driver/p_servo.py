...
def SetYD(yLangle,yUangle):
    positiony1 = int((yLangle*-10.8)+2350)
    positiony2 = int((yUangle*-10.56)+2200)
...
def SetY(Yangle):
    positiony1 = int(((Yangle**2)*0.0977)-23.527*Yangle+3056.8)
    positiony2 = int(((Yangle**2)*-0.0571)+2.4286*Yangle+2523.4)
    Maestro.setTarget(0,positiony2*4)
    Maestro.setTarget(1,positiony1*4) 
...
def ResetServo():
    ...
    Maestro.setSpeed(1,speed)
    Maestro.setSpeed(2,speed)
    acc = 20
    Maestro.setSpeed(0,acc)
    Maestro.setSpeed(1,acc)
    Maestro.setSpeed(2,acc)
    MoveServo(0,1578) 
    MoveServo(1,2067)
    MoveServo(2,1615)
